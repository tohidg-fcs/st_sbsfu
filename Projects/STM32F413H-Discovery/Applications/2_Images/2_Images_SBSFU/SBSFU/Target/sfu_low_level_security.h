...
/**
  ...
  *                   Execution capability disabled
  *                   STM32F411RET6: 128KB RAM
  */
#define SFU_PROTECT_MPU_SRAMACC_RGNV MPU_REGION_NUMBER5
#define SFU_PROTECT_MPU_SRAMACC_START SRAM1_BASE /*!< RAM memory area */
#define SFU_PROTECT_MPU_SRAMACC_SIZE MPU_REGION_SIZE_256KB
#define SFU_PROTECT_MPU_SRAMACC_SREG 0xE0U /*!< 256 Kbytes / 8 * 4 ==> 128 Kbytes */
...
/**
  ...
  *                   Read only capability configured
  *                   Inner region inside the Region 2
  *                   STM32F411RET6: Reduced to 512KB to cover SBSFU + slots
  */
...
#define APP_PROTECT_MPU_FLASHEXE_SREG \
    0x00U /*!< All subregions activated: SBSFU + SWAP + active/dwl slots */
...
#define SFU_STATIC_PROTECTION_WRP \
    ((uint32_t) 0x00000002U) /*!< Constants section in Flash. Needed as
                                                                            separate section to support PCRoP */
#define SFU_STATIC_PROTECTION_PCROP ((uint32_t) 0x00000004U) /*!< SFU App section in Flash */
#define SFU_STATIC_PROTECTION_LOCKED \
    ((uint32_t) 0x00000008U) /*!< RDP Level2 is applied. The device is Locked!
                                                                            Std Protections cannot be
                                                                            added/removed/modified */
#define SFU_STATIC_PROTECTION_BFB2 \
    ((uint32_t) 0x00000010U) /*!< BFB2 is disabled. The device shall always
                                                                            boot in bank1! */
...
#define SFU_RUNTIME_PROTECTION_ANTI_TAMPER \
    ((uint32_t) 0x00002000U) /*!< Anti-Tampering protections */
#define SFU_RUNTIME_PROTECTION_CLOCK_MONITOR \
    ((uint32_t) 0x00004000U) /*!< Activate a clock monitoring */
#define SFU_RUNTIME_PROTECTION_TEMP_MONITOR \
    ((uint32_t) 0x00008000U) /*!< Activate a Temperature monitoring */

#define SFU_STATIC_PROTECTION_ALL                                                          \
    (SFU_STATIC_PROTECTION_RDP | SFU_STATIC_PROTECTION_WRP | SFU_STATIC_PROTECTION_PCROP | \
     SFU_STATIC_PROTECTION_LOCKED)
    /*!< All the static protections */

#define SFU_RUNTIME_PROTECTION_ALL                                                             \
    (SFU_RUNTIME_PROTECTION_MPU | SFU_RUNTIME_PROTECTION_FWALL | SFU_RUNTIME_PROTECTION_IWDG | \
     SFU_RUNTIME_PROTECTION_DAP | SFU_RUNTIME_PROTECTION_DMA |                                 \
     SFU_RUNTIME_PROTECTION_ANTI_TAMPER | SFU_RUNTIME_PROTECTION_CLOCK_MONITOR |               \
...
#define SFU_CALLBACK_MEMORYFAULT(void) \
    MemManage_Handler(void) /*!<SFU Redirect of Mem Manage Callback*/
