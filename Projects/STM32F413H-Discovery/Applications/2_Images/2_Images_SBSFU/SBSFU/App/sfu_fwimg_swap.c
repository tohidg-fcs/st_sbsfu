...
static const int8_t SWAPPED[sizeof(SFU_LL_FLASH_write_t)] __attribute__((aligned(8))) = {0};
static const int8_t NOT_SWAPPED[sizeof(SFU_LL_FLASH_write_t)] __attribute__((aligned(8))) = {-1};
...
SFU_IMG_InitStatusTypeDef SFU_IMG_CheckSwapImageHandling(void)
{
   ...
   */
  if ((SFU_LL_FLASH_GetSector(SlotStartAdd[SLOT_SWAP])) <= SFU_PROTECT_WRP_PAGE_END_1)
  {
