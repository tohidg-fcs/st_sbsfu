...
#ifdef FLASH_ECCR_ECCD2
  if ((__HAL_FLASH_GET_FLAG(FLASH_ECCR_ECCD)) || (__HAL_FLASH_GET_FLAG(FLASH_ECCR_ECCD2)))
#else /* FLASH_ECCR_ECCD2 */
  if (__HAL_FLASH_GET_FLAG(FLASH_ECCR_ECCD))
#endif /* FLASH_ECCR_ECCD2 */
  {
    __HAL_FLASH_CLEAR_FLAG(FLASH_ECCR_ECCD);
#ifdef FLASH_ECCR_ECCD2
    __HAL_FLASH_CLEAR_FLAG(FLASH_ECCR_ECCD2);
#endif /* FLASH_ECCR_ECCD2 */
