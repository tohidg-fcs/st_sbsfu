...
set PARENT_CERT_FOLDER=SBSFU_SAMPLE_INTER1_OEM1_CA
set CERT_FULLNAME=Intermediate 2 : OEM 1
set WORK_FOLDER=SBSFU_SAMPLE_INTER2_OEM1_CA
set work_radix_name=sbsfu_inter2_oem1
