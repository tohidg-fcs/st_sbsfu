                                        ...
                                        CK_OBJECT_HANDLE_PTR phPrivateKey)
{
  ...
  /* Extract curve and data len from key OID */
  /* Depending on this parameter, a different key pair can be generated - actual type available depends on the
...
/**
  ...
  *           the content length.
  *           This implementation does NOT support long length octets
                                      ...
                                      CK_ULONG ulValueInLen)
{
  ...
  /* Check Length*/
  /* Note: This implementation does NOT support long length octets ( i.e. Length field > 128 (0x80)).*/
