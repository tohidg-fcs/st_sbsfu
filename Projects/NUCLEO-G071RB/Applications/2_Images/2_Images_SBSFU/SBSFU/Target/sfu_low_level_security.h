...
#else
#define SFU_PROTECT_MPU_FLASHEXE_SREG  0x00U               /*!< All subregions activated */
#endif /* (__CC_ARM) || defined(__ARMCC_VERSION) */
...
#define SFU_PROTECT_MPU_SRAMACC_SIZE  MPU_REGION_SIZE_64KB
#define SFU_PROTECT_MPU_SRAMACC_SREG  0xE0                 /*!< 64 Kbytes / 8 * 5 ==> 40 Kbytes */
