...
static void TEST_PROTECTIONS_RunSecHeader(void);
...
static void TEST_PROTECTIONS_RunTAMPER(void)
{
  ...
  /* Print instructions*/
  printf("  -- Pull PA0 (CN4.12) to GND \r\n\n");
  printf("  -- -- Note: sometimes it may be enough to put your finger close to PA0 (CN4.12)\r\n\n");
