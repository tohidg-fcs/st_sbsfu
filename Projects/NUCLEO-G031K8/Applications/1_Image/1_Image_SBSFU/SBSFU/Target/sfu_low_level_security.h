...
#define SFU_PROTECT_MPU_FLASHACC_SIZE  MPU_REGION_SIZE_64KB
...
#define SFU_PROTECT_MPU_FLASHEXE_SREG  0xE0U               /*!< 64 Kbytes / 8 * 5 ==> 40 Kbytes */
#elif defined (__GNUC__)
#define SFU_PROTECT_MPU_FLASHEXE_SREG  0xE0U               /*!< 64 Kbytes / 8 * 5 ==> 40 Kbytes */
#else
#define SFU_PROTECT_MPU_FLASHEXE_SREG  0xF0U               /*!< 64 Kbytes / 8 * 4 ==> 32 Kbytes */
...
#define SFU_PROTECT_MPU_SRAMACC_SIZE  MPU_REGION_SIZE_8KB
...
#define SFU_PROTECT_MPU_SRAM_SE_SREG  0x80U                    /*!< 4 Kbytes / 8 * 7 ==> 3,5 Kbytes */
...
#elif defined (__GNUC__)
#define SFU_PROTECT_MPU_SRAM_HDP_SREG  0xE0U                /*!< 5 first subregions activated */
#else
#define SFU_PROTECT_MPU_SRAM_HDP_SREG  0x00U                /*!< All subregions activated */
#endif
...
#elif defined (__GNUC__)
#define SFU_PROTECT_MPU_EXEC_SE_SREG  0xF0U                /*!< 32 Kbytes / 8 * 4 ==> 16 Kbytes */
#else
#define SFU_PROTECT_MPU_EXEC_SE_SREG  0xF8U                /*!< 32 Kbytes / 8 * 3 ==> 12 Kbytes */
#endif /* (__CC_ARM) || (__ARMCC_VERSION) */
