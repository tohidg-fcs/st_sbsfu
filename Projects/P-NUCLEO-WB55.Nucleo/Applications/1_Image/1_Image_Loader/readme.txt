...
@par Directory contents
   ...
   - 1_Image_LOADER/Src/loader.c                      Image download services
   - 1_Image_LOADER/Src/loader_low_level.c            General (CRC, UART) low level interface
   - 1_Image_LOADER/Src/loader_low_level_flash.c      Flash low level interface (wrapper)
   - 1_Image_LOADER/Src/loader_low_level_flash_int.c  Internal flash low level interface
   - 1_Image_LOADER/Src/loader_low_level_flash_ext.c  External flash low level interface
   - 1_Image_LOADER/Src/main.c                        Main application file
   - 1_Image_LOADER/Src/stm32wbxx_it.c                STM32 interrupt handlers
   - 1_Image_LOADER/Src/system_stm32wbxx.c            STM32 system file
   - 1_Image_LOADER/Inc/loader.h                      Header for loader.c file
   - 1_Image_LOADER/Inc/loader_low_level.h            Header for loader_low_level.c file
   - 1_Image_LOADER/Inc/loader_low_level_flash.h      Header for loader_low_level_flash file
   - 1_Image_LOADER/Inc/loader_low_level_flash_int.h  Header for loader_low_level_flash_int file
   - 1_Image_LOADER/Inc/loader_low_level_flash_ext.h  Header for loader_low_level_flash_ext file
   - 1_Image_LOADER/Inc/main.h                        Header for main.c file
   - 1_Image_LOADER/Inc/stm32wbxx_conf.h              HAL configuration file
   - 1_Image_LOADER/Inc/stm32wbxx_it.h                Header for stm32wbxx_it.h file

@par Hardware and Software environment

   - This example runs on STM32WB55xx devices.
   - This example has been tested with P-NUCLEO-WB55 board and can be easily tailored to any other supported device and
     development board.
...
2. To download a firmware, send the user encrypted firmware file (\1_Image\1_Image_UserApp\Binary\UserApp.sfb)
...
3. After reception of the header part of the firmware, the length and the firmware version (anti-rollback)
   is controlled.
   Then the image is stored in the downloaded area (slot #1) defined in \1_Image\Linker_Common\ mapping files.
