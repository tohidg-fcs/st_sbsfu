...
/* Active slot #1  (140 kbytes) */
#define SLOT_ACTIVE_1_START          0x0805D000
#define SLOT_ACTIVE_1_END            0x0807FFFF
#define SLOT_ACTIVE_1_HEADER         0x08016000

/* Dwl slot #1  (140 KBytes) */
#define SLOT_DWL_1_START             0x08017000
#define SLOT_DWL_1_END               0x08039FFF

/* Backup (140 Kbytes) */
#define BACKUP_START                 0x0803A000
#define BACKUP_END                   0x0805CFFF
