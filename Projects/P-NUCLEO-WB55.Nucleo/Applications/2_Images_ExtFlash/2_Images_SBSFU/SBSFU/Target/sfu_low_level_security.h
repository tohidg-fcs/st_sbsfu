...
/**
  * Region definition : from 0x0806 0000 ==> 0x0807FFFF (128 kbyte)
  */
#define APP_PROTECT_MPU_AREA_ACTIVE_SLOT_START  0x08060000U
#define APP_PROTECT_MPU_AREA_ACTIVE_SLOT_SIZE   MPU_REGION_SIZE_128KB
...
/**
  * Additional Region definition : from 0x0805 D000 ==> 0x0805 FFFF (12 kbyte)
  */
#define APP_PROTECT_MPU_AREA_2_ACTIVE_SLOT_START  0x0805C000U
#define APP_PROTECT_MPU_AREA_2_ACTIVE_SLOT_SIZE   MPU_REGION_SIZE_16KB
...
#define APP_PROTECT_MPU_AREA_2_ACTIVE_SLOT_SREG   0x03U                    /*!< 16 Kbytes / 8 * 6 ==> 12 Kbytes */


/**
  * MPU configuration for Standalone loader execution
  * =================================================
  * @brief Region 6 - Enable the execution
  * MPU constraint = Region base address should be aligned on Region size
  */
...
#define LOADER_PROTECT_MPU_AREA_SREG   0xE0U                                /*!< 32 Kbytes / 8 * 5 ==> 20 Kbytes */
