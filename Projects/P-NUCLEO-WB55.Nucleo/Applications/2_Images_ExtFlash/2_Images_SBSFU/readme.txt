...
7. At startup (Power On or Reset button pushed) welcome information are displayed on terminal emulator.
   Green LED is turned on when a BLE download is waited.
...
Note1 : Press User push-button (SW1) at reset to force a local download if an application is already installed.
