...
#define LOADER_UART_TX_GPIO_PORT                   GPIOB
#define LOADER_UART_TX_PIN                         GPIO_PIN_6
#define LOADER_UART_TX_GPIO_CLK_ENABLE()           __HAL_RCC_GPIOB_CLK_ENABLE()
#define LOADER_UART_TX_GPIO_CLK_DISABLE()          __HAL_RCC_GPIOB_CLK_DISABLE()

#define LOADER_UART_RX_AF                          GPIO_AF7_USART1
#define LOADER_UART_RX_GPIO_PORT                   GPIOB
#define LOADER_UART_RX_PIN                         GPIO_PIN_7
#define LOADER_UART_RX_GPIO_CLK_ENABLE()           __HAL_RCC_GPIOB_CLK_ENABLE()
#define LOADER_UART_RX_GPIO_CLK_DISABLE()          __HAL_RCC_GPIOB_CLK_DISABLE()

/* Redirect of RTC Tamper Event Callback */
#define  CALLBACK_Antitamper                       HAL_RTCEx_Tamper2EventCallback
