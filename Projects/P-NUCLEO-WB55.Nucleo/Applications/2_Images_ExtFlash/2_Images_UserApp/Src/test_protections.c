...
static void TEST_PROTECTIONS_RunCORRUPT(uint32_t slot_number)
{
  ...
  printf("  -- At next boot Signature Verification will fail. The FW image will be restored from the backup slot.\r\n\n");
...
static void TEST_PROTECTIONS_RunTAMPER(void)
{
  ...
  /* Print instructions*/
  printf("  -- Pull PA0 (CN8.4) to GND \r\n\n");
  printf("  -- -- Note: sometimes it may be enough to put your finger close to PA0 (CN8.4)\r\n\n");
