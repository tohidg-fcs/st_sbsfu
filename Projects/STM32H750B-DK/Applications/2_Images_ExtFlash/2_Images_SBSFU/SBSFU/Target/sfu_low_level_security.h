...
/* Exported constants --------------------------------------------------------*/
/* Secure User Memory end : from FLASH_BASE to end of SBSFU */
...
#define SFU_PROTECT_WRP_PAGE_END_1      ((uint32_t)((SFU_ROM_ADDR_END - FLASH_BASE) / FLASH_SECTOR_SIZE))
...
#define SFU_PROTECT_MPU_FLASHACC_SIZE  MPU_REGION_SIZE_128KB
...
/**
  ...
  *                   Inner region inside the Region 2
  */
/* not useful since header is located inside external memory
   counter mechanism implemented for anti-rollback control */
/**
...
#define SFU_PROTECT_MPU_EXEC_SE_SREG  0x80U                /*!< 32 Kbytes / 8 * 7 ==> 28Kbytes */
#else
