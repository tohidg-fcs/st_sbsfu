...
Installation
=================================
Python 3 is required to execute this tool. It has been tested with Python 3.7.4.
This version or a more recent version can be used.
Additionally, some Python packages are required.
It is recommended to install the python packages dependencies with this command:
>pip install -r requirements.txt