...
CK_RV KMS_Entry(KMS_FunctionID_t eID, va_list arguments)
{
  ...
  switch (eID & (~KMS_CLUST_MASK))
  {
    case KMS_INITIALIZE_FCT_ID:
    {
      ...
      KMS_LL_IsBufferInSecureEnclave((void *)pInitArgs, sizeof(CK_C_INITIALIZE_ARGS_PTR));
      if (pInitArgs != NULL)
      {
        KMS_LL_IsBufferInSecureEnclave((void *)((CK_C_INITIALIZE_ARGS_PTR)pInitArgs)->CreateMutex, sizeof(CK_CREATEMUTEX));
        KMS_LL_IsBufferInSecureEnclave((void *)((CK_C_INITIALIZE_ARGS_PTR)pInitArgs)->DestroyMutex, sizeof(CK_DESTROYMUTEX));
        KMS_LL_IsBufferInSecureEnclave((void *)((CK_C_INITIALIZE_ARGS_PTR)pInitArgs)->LockMutex, sizeof(CK_LOCKMUTEX));
        KMS_LL_IsBufferInSecureEnclave((void *)((CK_C_INITIALIZE_ARGS_PTR)pInitArgs)->UnlockMutex, sizeof(CK_UNLOCKMUTEX));
      }
#endif /* KMS_SE_CHECK_PARAMS */
    ...
    case KMS_FINALIZE_FCT_ID:
    {
      ...
      KMS_LL_IsBufferInSecureEnclave((void *)pReserved, sizeof(CK_VOID_PTR));
#endif /* KMS_SE_CHECK_PARAMS */
